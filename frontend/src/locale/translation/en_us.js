// BrickFlow real estate expense categories (for UI selection only)
const lang = {
  expense_category_construction: 'Construction',
  expense_category_labour: 'Labour',
  expense_category_materials: 'Materials',
  expense_category_utilities: 'Utilities',
  expense_category_legal: 'Legal',
  expense_category_miscellaneous: 'Miscellaneous',
  sign_up: 'Sign Up',
  manage_your_company_with: 'Manage Your Enterprise With',
  ...
  it_brings_together_your_invoice_clients_and_leads:
    'It Brings Together Your Invoice Customers And Leads',
  ...
  company_settings: 'Enterprise Settings',
  company_logo: 'Enterprise Logo',
  ...
  update_your_company_informations: 'Update Your Enterprise Informations',
  company_name: 'Enterprise Name',
  company_address: 'Enterprise Address',
  company_state: 'Enterprise State',
  company_country: 'Enterprise Country',
  company_email: 'Enterprise Email',
  company_phone: 'Enterprise Phone',
  company_cell: 'Enterprise Cell',
  company_website: 'Enterprise Website',
  company_tax_number: 'Enterprise Tax Number',
  company_vat_number: 'Enterprise Vat Number',
  company_reg_number: 'Enterprise Reg Number',
  update_company_logo: 'Update Enterprise Logo',
  money_format_settings: 'Money Format Settings',
  default_currency: 'Default Currency',
  select_default_currency: 'Select Default Currency',
  update_company_finance_settings: 'Update Enterprise Finance Settings',
  ...
  add_new_company: 'Add New Enterprise',
  submit: 'Submit',
  person: 'Person',
  people_list: 'People List',
  firstname: 'Firstname',
  lastname: 'Lastname',
  company_list: 'Enterprise List',
  contact: 'Contact',
  website: 'Website',
  lead_list: 'Lead List',
